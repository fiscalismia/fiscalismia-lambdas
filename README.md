...
PYTHON_V="python3.13"
alias podman='docker' && bash create_layer_archive.sh $RUNTIME_ENV $DOCKER_IMG $LAYER_NAME $PROGRAMMING_LANG $PYTHON_V
```
...
NODE_V="node24"
alias podman='docker' && bash create_layer_archive.sh $RUNTIME_ENV $DOCKER_IMG $LAYER_NAME $PROGRAMMING_LANG $NODE_V
```
